	...
	public static int UniqueID
	{
		...
		reroll:
			...
			if (m_UniqueIDs.ContainsKey(i))	// likely won't happen (ever)
			{
				...
				{
					ClearUniqueIDs();
					MessageBox.DEBUG("Warning (vp_Utility.UniqueID) More than 1 billion unique IDs have been generated. This seems like an awful lot for a game client. Clearing dictionary and starting over!");
				}
				goto reroll;
			}
			m_UniqueIDs.Add(i, 0);
