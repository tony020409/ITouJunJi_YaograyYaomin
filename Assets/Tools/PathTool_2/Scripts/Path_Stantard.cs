...
namespace PathTool
{
    ...
    /// <summary>
    public class Path_Stantard : MonoBehaviour
    {
        /// <summary>
        ...
        void Awake()
        {
            PathTool_Manager.AddPath(gameObject);
        }
        ...
        void OnDrawGizmos()
        {
            ...
            if (drawCurved && wpPositions.Length >= 2)
                PathTool_Manager.DrawCurved(wpPositions);
            else
                PathTool_Manager.DrawStraight(wpPositions);
        }
