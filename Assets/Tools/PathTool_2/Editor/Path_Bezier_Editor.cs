...
namespace PathTool
{
    ...
    /// <summary>
    [CustomEditor(typeof(Path_Bezier))]
    public class BezierPathEditor : Editor
    {
        //define reference we want to use/control
        private Path_Bezier script;
        ...
        public override void OnInspectorGUI()
        {
            ...
            float pathLength = PathTool_Manager.GetPathLength(script.pathPoints);
            ...
            if (GUILayout.Button("Continue Editing"))
            {
                ...
                PathTool_Manager_Editor.ContinuePath(script);
            }
