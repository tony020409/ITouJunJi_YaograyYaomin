...
namespace PathTool
{
    ...
    [CustomEditor(typeof(Path_Stantard))]
    public class Path_Stantard_Editor : Editor
    {
        //define Serialized Objects we want to use/control
        //this will be our serialized reference to the inspected script
        private SerializedObject m_Object;
        private SerializedProperty m_Waypoint;       //serialized waypoint array
        private SerializedProperty m_WaypointsCount; //serialized waypoint array count
        private SerializedProperty m_Check1;         //serialized path gizmo property booleans 1
        private SerializedProperty m_Check2;         //serialized path gizmo property booleans 2
        private SerializedProperty m_Color1;         //serialized scene view gizmo colors 1
        private SerializedProperty m_Color2;         //serialized scene view gizmo colors 2
        private SerializedProperty m_SkipNames;     //serialized custom waypoint renaming bool
        private SerializedProperty m_WaypointPref;  //serialized replace object gameobject
        ...
        public override void OnInspectorGUI(){
            ...
            if (m_WaypointsCount.intValue < 2){
                ...
                if (GUILayout.Button("Create Path from Children")){
                    ...
                    (m_Object.targetObject as Path_Stantard).Create();
            ...
            float pathLength = PathTool_Manager.GetPathLength(wpPositions);
            ...
            {
                Selection.activeGameObject = (GameObject.FindObjectOfType(typeof(PathTool_Manager)) as PathTool_Manager).gameObject;
                PathTool_Manager_Editor.ContinuePath(m_Object.targetObject as Path_Stantard);
            }
        ...
        void OnSceneGUI()
        {
            ...
            switch (m_Check1.boolValue)
            {
                case true:
                    ...
                    pathPoints = PathTool_Manager.GetCurved(pathPoints);
